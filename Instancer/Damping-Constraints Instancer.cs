...
namespace VRLabs.DampingConstraints
{
	public class DampingConstraints : ScriptableObject
	{
		public const string packageName = "Damping-Constraints";
		...
		[MenuItem("VRLabs/Create Instance/Damping Constraints")]
		public static void FancyPackage()
		{
			...
			var editor = ScriptableObject.CreateInstance<DampingConstraints>();
